...
Access any feature quickly with the command palette:

- Press **Cmd+K** (Mac) or **Ctrl+K** (Windows/Linux)
- Search for pages, stakeholders, projects, or actions
- Navigate instantly without using the mouse

### Keyboard shortcuts

Common shortcuts for faster workflows:
...
- **Stakeholders**: People database
- **Change Impacts**: Impact registry
