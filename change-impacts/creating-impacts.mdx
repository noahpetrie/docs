...
- **Category** - Select one or more impact types:
  ...
  - Policy/Compliance
  - Culture
- **Severity** - Based on effort and disruption:
  - **Critical** - Major disruption requiring immediate attention
  - **High** - Significant impact needing careful management
  - **Medium** - Moderate impact with standard change management
  - **Low** - Minor impact with minimal intervention
...
## Bulk status and severity updates

Update multiple impacts at once:

1. Select impacts using checkboxes in the table
2. Click **Bulk Actions**
3. Choose **Update Status** or **Update Severity**
4. Select the new value
5. Apply to all selected impacts
...
<AccordionGroup>
  ...
  <Accordion title="Be conservative with severity">
    Reserve "Critical" and "High" for impacts requiring significant behavior change or affecting critical processes.
  </Accordion>
